...
def train():
    ...
    recognizer_trainer(EigenFace_recognizer)
    print("EigenFace tanitas befejezodott")

def eigenFace():
    print("EigenFace Teszt elindult")
    ...
    def predict(test_image):
        ...
        # becslés
        label= EigenFace_recognizer.predict(resized_test_image)
    ...
    cv2.imshow('EigenFace teszt ablak', pred_img)
    cv2.waitKey(0)